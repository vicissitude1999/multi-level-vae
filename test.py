...
parser.add_argument('--save_original', type=bool) # save the original images
...
def get_reconstructions(model, X, eta):
    ...
    g1_reconstructions, g1_reconstruction_error = extract_reconstructions(g1, style_mu_g1, class_mu_g1, class_logvar_g1, 50)
    g2_reconstructions, g2_reconstruction_error = extract_reconstructions(g2, style_mu_g2, class_mu_g2, class_logvar_g2, 50)
...
if __name__ == '__main__':
    ...
    ds = alternate_data_loader.celeba_test_change_person(50, 10)
