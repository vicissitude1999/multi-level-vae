...
if __name__ == '__main__':
    ...
    for i in range(len(test_data)): # Running X_i
        ...
        for eta in range(max(1, cps[i]-20), min(cps[i]+20, paired_mnist.T)):
            ...
            style_mu_bef, class_mu_bef, class_logvar_bef = style_mu[:eta], class_mu[:eta], class_logvar[:eta]
            style_mu_aft, class_mu_aft, class_logvar_aft = style_mu[eta:], class_mu[eta:], class_logvar[eta:]
